...
export function hook(proxy) {
	...
	unsafeWindow[realXhr] = unsafeWindow[realXhr] || unsafeWindow.XMLHttpRequest;

	unsafeWindow.XMLHttpRequest = function () {
		var xhr = new unsafeWindow[realXhr]();
	...
	return unsafeWindow[realXhr];
}

export function unHook() {
	if (unsafeWindow[realXhr]) unsafeWindow.XMLHttpRequest = unsafeWindow[realXhr];
	unsafeWindow[realXhr] = undefined;
}
