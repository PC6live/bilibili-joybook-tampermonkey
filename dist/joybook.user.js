...
// @version       0.0.14
// @require       file:E:\Code\Tampermonkey\bilibili-joybook-tampermonkey\packages\core\dist\joybook.user.js
// ==/UserScript==
'use strict';
...
(() => {
    ...
    // 更改服务端渲染携带的用户信息
    unlockVideo();
    const switchUser = () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const isVip = (userId === null || userId === void 0 ? void 0 : userId.value) !== (currentId === null || currentId === void 0 ? void 0 : currentId.value);
